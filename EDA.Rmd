...
The raw dataset underwent extensive cleaning prior to analysis. Initially, rows with missing FAH values (109 rows) were removed, and FAH levels were encoded numerically from 0 to 4 to preserve their ordinal structure. Other categorical variables, including precipitation type and forecast region, were also converted to integer codes. The Date column was transformed into Month to capture seasonal effects.
